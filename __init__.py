...
from .nodes_video import NODE_CLASS_MAPPINGS as _VIDEO_CLASSES
from .nodes_video import NODE_DISPLAY_NAME_MAPPINGS as _VIDEO_NAMES
...
try:
    ...
    import logging
    logging.warning(f"[FEnodes] Failed to load Radiance VAE nodes: {e}")
    _VAE_CLASSES = {}
    _VAE_NAMES = {}
